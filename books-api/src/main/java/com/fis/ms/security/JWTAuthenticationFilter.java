...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter
{
      ...
      throws AuthenticationException
   {
      try
      {
         ...
         UsernamePasswordAuthenticationToken userPwdAuthToken =
            new UsernamePasswordAuthenticationToken(creds.getSubscriberName(), creds.getPassword(),
               new ArrayList<>());
         Authentication auth = authenticationManager.authenticate(userPwdAuthToken);
         return auth;
      }
      catch (IOException e)
      {
      ...
      FilterChain chain, Authentication auth) throws IOException, ServletException
   {
      ...
      res.addHeader(SecurityConstants.HEADER_CUSTOM_HEADER, SecurityConstants.HEADER_CUSTOM_HEADER_VALUES);
   }
}